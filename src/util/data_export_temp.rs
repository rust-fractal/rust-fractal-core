...
impl DataExport {
    pub fn new(image_width: usize, image_height: usize, display_glitches: bool, data_type: DataType, palette: Vec<(u8, u8, u8)>, iteration_division: f32, palette_offset: f32, analytic_derivative: bool) -> Self {
        ...
        let mut buffer = rgb.lock().unwrap();
    ...
    pub fn export_pixels(&mut self, pixel_data: &[PixelData], reference: &Reference, delta_pixel: FloatExtended) {
        ...
        match self.data_type {
            DataType::NONE => {},
            DataType::COLOUR => {
                let mut buffer = self.rgb.lock().unwrap();
                ...
                for pixel in pixel_data {
                    ...
                    if pixel.glitched && self.display_glitches {
                        ...
                        buffer[k] = (colour1.0 as f32 + temp4 * (colour2.0 as f32 - colour1.0 as f32)) as u8; 
                        buffer[k + 1] = (colour1.1 as f32 + temp4 * (colour2.1 as f32 - colour1.1 as f32)) as u8; 
                        buffer[k + 2] = (colour1.2 as f32 + temp4 * (colour2.2 as f32 - colour1.2 as f32)) as u8;
    ...
    pub fn save_colour(&mut self, filename: &str) {
        let buffer = self.rgb.lock().unwrap();
    ...
    pub fn clear_buffers(&mut self) {
        ...
        match self.data_type {
            DataType::NONE => {},
            DataType::COLOUR => {
                *buffer = vec![0u8; self.image_width * self.image_height * 3];
            }
            DataType::GUI => {
                *buffer = vec![0u8; self.image_width * self.image_height * 3];
    ...
    pub fn colour_index(&mut self, i: usize) {
        ...
        if self.glitched[i] && self.display_glitches {
            ...
            buffer[3 * i] = rgb.r as u8; 
            buffer[3 * i + 1] = rgb.g as u8; 
            buffer[3 * i + 2] = rgb.b as u8;
            ...
            buffer[3 * i] = (colour1.0 as f32 + temp4 * (colour2.0 as f32 - colour1.0 as f32)) as u8; 
            buffer[3 * i + 1] = (colour1.1 as f32 + temp4 * (colour2.1 as f32 - colour1.1 as f32)) as u8; 
            buffer[3 * i + 2] = (colour1.2 as f32 + temp4 * (colour2.2 as f32 - colour1.2 as f32)) as u8;
        }
    }
