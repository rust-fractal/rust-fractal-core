...
pub struct ImageRenderer<T> {
    ...
    pub x_n: Vec<ComplexFixed<T>>,
    pub x_n_2: Vec<ComplexFixed<T>>,
    pub tolerance_check: Vec<T>,
    pub reference_delta: ComplexFixed<T>,
    resolution: T,
...
impl<T> ImageRenderer<T> {
    pub fn new(image_width: usize, image_height: usize, initial_zoom: T, maximum_iterations: usize, center_re: &str, center_complex: &str, precision: u32, glitch_tolerance: f32, display_glitches: bool) -> Self {
        ...
        let aspect = image_width as T / image_height as T;
    ...
    pub fn render(&mut self) {
        ...
        while points_remaining.len() as f64 > (self.glitch_tolerance * (self.image_width * self.image_height) as f64) {
            ...
            self.calculate_perturbations_f64_vectorised(&mut points_remaining, &mut points_complete);
